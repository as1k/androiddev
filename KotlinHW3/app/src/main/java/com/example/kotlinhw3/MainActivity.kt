...
enum class Operation {
    PLUS, MINUS, DIVIDE, MULTIPLY, POW, PERCENT, SQRT, UNDEFINED, SIN, COS, TAN, COT, SQR, FACTORIAL, LN, LOG
}
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnSqr: Button = findViewById(R.id.btnSqr)
        ...
        val calculatorListener = View.OnClickListener { v ->
            when (v.id) {
                ...
                R.id.btnSin -> {
                    ...
                    dotted = false
                    tvInput.text = sin(Math.toRadians(valueOne)).toString()
                }
                R.id.btnCos -> {
                    state = State.DOESNTMATTER
                    ...
                    dotted = false
                    tvInput.text = cos(Math.toRadians(valueOne)).toString()
                }
                R.id.btnTan -> {
                    state = State.DOESNTMATTER
                    ...
                    dotted = false
                    tvInput.text = tan(Math.toRadians(valueOne)).toString()
                }
                R.id.btnCot -> {
                    state = State.DOESNTMATTER
                    ...
                    dotted = false
                    tvInput.text = (1 / tan(Math.toRadians(valueOne))).toString()
                }
                R.id.btnE -> {
                    state = State.DOESNTMATTER
                    operation = Operation.UNDEFINED
                ...
                R.id.btnSqr -> {
                    ...
                    if (tvInput.text.toString() == "Error!") {
                        ...
                        tvInput.text = (valueOne * valueOne).toString()
                        dotted = false
                    }
                }
                R.id.btnLn -> {
                    ...
                    when {
                        ...
                        valueOne == 2.71828182845904 -> {
                            tvInput.text = "1"
                        }
                        else -> {
                            tvInput.text = ln(valueOne).toString()
                            dotted = false
                        }
                    }
                }
                R.id.btnLog -> {
                    ...
                    when {
                        ...
                        valueOne == 0.0 -> {
                            ...
                            tvInput.text = log10(valueOne).toString()
                            dotted = false
                        }
                    }
                }
                R.id.btnFactorial -> {
                    ...
                    if (tvInput.text.toString() == "Error!") {
                        ...
                        tvInput.text = ans.toDouble().toString()
                        dotted = false
                    }
                }
            }
